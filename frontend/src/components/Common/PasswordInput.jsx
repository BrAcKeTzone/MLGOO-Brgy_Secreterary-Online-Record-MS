    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          title="Password must be 8-16 characters long and contain at least one uppercase letter, one lowercase letter, and one number"
        />
        <button
          type="button"
      ...
      {showStrength && value && (
        <div className="mt-2">
          ...
          <p
            className={`text-xs mt-1 ${getStrengthColor(
              score
            )} text-${getStrengthColor(score).replace("bg-", "")}`}
          >
            {feedback}
          </p>
        </div>
