    ...
    <div className="bg-white rounded-lg shadow-md">
      <div className="overflow-hidden">
        {notifications.map((notification) => (
          <div
            key={notification.id}
            className={`border-b border-gray-200 p-4 hover:bg-gray-50 cursor-pointer transition-all 
              ${notification.isRead ? "opacity-75" : "bg-blue-50 shadow-sm"}`}
            onClick={() =>
            ...
            <div className="flex items-start">
              ...
              <div className="flex-grow">
                ...
                {notification.isRead ? (
                  ...
                  <div className="flex items-center space-x-2 my-1 py-2 px-3 bg-white rounded-md border border-blue-100">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  {!notification.isRead && (
                    <button
                      ...
                      className="text-xs text-blue-600 hover:text-blue-800 bg-white px-2 py-1 rounded-full shadow-sm border border-blue-100 hover:shadow-md transition-all"
                    >
                      Mark as read
                    </button>
                  )}
